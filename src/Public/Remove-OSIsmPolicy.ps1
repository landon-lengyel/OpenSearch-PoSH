function Remove-OSIsmPolicy {
    <#
    .SYNOPSIS
        Removes an Index State Management (ISM) policy from an index.
    ...
    $Request = '_plugins/_ism/remove/' + $Index + $UrlParameterString
...
Export-ModuleMember -Function Remove-OSIsmPolicy
