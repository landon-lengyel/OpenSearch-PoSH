function Stop-OSTask {
    ...
    $Response = Invoke-OSCustomWebRequest -Method 'POST' -Request $Request -OpenSearchUrls $OpenSearchURL -Credential $Credential -Certificate $Certificate
...
Export-ModuleMember -Function Stop-OSTask
